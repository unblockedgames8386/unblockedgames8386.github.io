      ...
      _oEnergyP.rotation=180; 
       ...
       //Functional buttons//
        ...
        if(DISABLE_SOUND_MOBILE === false || s_bMobile === false){
                ...
                _pStartPosFullscreen = {x:_pStartPosAudio.x - oSprite.width/2 - 10,y:50};
        }else{
                oSprite = s_oSpriteLibrary.getSprite('but_fullscreen');
                _pStartPosFullscreen = {x: (CANVAS_WIDTH -120), y: 50};
        }		
